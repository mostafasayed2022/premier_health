...
const FALLBACK_SERVICES: ServiceItem[] = [
  ...
  {
    id: "recovery",
    name_ar: "الاستشفاء والنشاط البدني",
    description_ar:
      "أحماض أمينية وإلكتروليتات لاستعادة الحيوية والنشاط بعد الإجهاد البدني والتمارين الرياضية.",
    icon: Heart,
    color: "text-red-500",
  },
  {
    id: "brain-boost",
    name_ar: "الصفاء الذهني ومقاومة الإجهاد",
    description_ar:
      "مغنيسيوم وفيتامينات B لدعم النشاط الذهني والتركيز وتخفيف الإرهاق اليومي.",
    icon: Brain,
