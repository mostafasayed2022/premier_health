      ...
      {departments.map((dept) => {
        ...
        return (
          ...
          >
            ...
            <div className="relative w-14 h-14 rounded-xl overflow-hidden shrink-0 border border-accent/20 bg-beige/50 flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform">
              {photoSrc ? (
                <Image
                  src={photoSrc}
                  alt={name || "Department"}
