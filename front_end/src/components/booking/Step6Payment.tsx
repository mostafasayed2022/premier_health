          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-serif font-bold text-primary text-base group-hover:text-accent transition-colors">
                  {m.label}
                </h3>
                <p className="text-[11px] text-foreground/70 mt-0.5 font-medium line-clamp-1">
                  {m.subtitle}
                </p>
              </div>
