...
> = {
  ar: {
    title: "عيادات بريمير هيلث | أفضل عيادة علاج وريدي، جلدية وتجميل في مصر",
    description:
      "عيادات بريمير هيلث - الوجهة الأولى للرعاية الصحية الفاخرة، باقات العلاج والتقطير الوريدي IV Therapy، العناية بالجلدية، والتجميل في القاهرة (فيرمونت نايل سيتي، أركان بلازا الشيخ زايد، سوديك EDNC التجمع).",
    keywords: [
      "بريمير هيلث",
      "عيادة بريمير هيلث",
      "عيادات بريمير هيلث",
      ...
      "عيادة فيرمونت نايل سيتي",
      "عيادة اركان بلازا الشيخ زايد",
      "عيادة سوديك EDNC التجمع الخامس",
      "بوتوكس وفيلر",
      "جلسات نضارة البشرة",
      "تجديد الخلايا والطاقة",
      "رعاية صحية فاخرة",
  ...
  en: {
    ...
    keywords: [
      ...
      "Vitamin Drip Cairo",
      "NAD+ Infusion Cairo",
      "Myers Cocktail Egypt",
      "Luxury Medical Clinic Cairo",
      "Best Dermatology Clinic Egypt",
      "Aesthetic Medicine Cairo",
      "Fairmont Nile City Clinic",
      "Arkan Plaza Clinic Sheikh Zayed",
      "EDNC Sodic Clinic New Cairo",
      "Anti-Aging Clinic Egypt",
      "Botox and Fillers Cairo",
      "Skin Rejuvenation Cairo",
      "Wellness Clinic Egypt",
      "Medical Tourism Cairo",
    ],
  },
  fr: {
...
> = {
  home: {
    ...
    en: {
      ...
      keywords: [
        "Premier Health Clinics",
        "Premier Health Cairo",
        "Luxury Wellness Clinic",
        "IV Therapy Clinic Cairo",
        "Aesthetic Medicine Egypt",
        "Dermatology Clinic Zayed",
        "NAD Therapy Cairo",
      ],
    },
    fr: {
